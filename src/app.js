...
const complainManagment = require('./routes/routesComplainManagement.js');
...
app.use('/dev-app-tms/complainManagment',complainManagment);

// Swagger
app.use("/dev-app-tms/api-docs", swaggerUi.serve, swaggerUi.setup(swaggerSpec));
