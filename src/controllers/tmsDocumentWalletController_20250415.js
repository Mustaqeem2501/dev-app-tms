        ...
        if (AccessToken != null) {
            ...
            if (user_info && user_info.Status === 2) {
                ...
                if(result.length>0) {                    
                    ...
                    let docNumValidation = await validateDocumentNo(DocumentNo, 'add');
        ...
        if (AccessToken != null) {
            ...
            if (user_info && user_info.Status === 2) {
                ...
                if(result.length>0) {                    
                    ...
                    let docNumValidation = await validateDocumentNo(DocumentNo, 'edit');
                    if (docNumValidation === 'Yes') {
                        response.Status = "fail";
                        response.Message = "Document Number is already exist in database. Please check once";
                        return res.status(400).json(response);
...
async function validateDocumentNo(DocumentNo, action) {
