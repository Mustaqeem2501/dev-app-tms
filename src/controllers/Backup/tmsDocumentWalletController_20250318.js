...
exports.documentBulkUpload123456 = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).json({
            Status: "Success",
            Message: errors,
            insert_rows_count: updatedRowsCount
        });
    } catch (error) {
        console.error("Error:", error);
        return res.status(500).json({
...
exports.documentBulkUpload90444010 = async (req, res) => {
    try {
        const { body, files } = req;
        ...
        return res.status(200).json({
            Status: "Success",
            Message: errors,
            result: {insert_rows_count:insertedRowsCount,inserted_ids:{vehicle_driver:{document_id:result1,reminder_id:result2}}}
        });
    } catch (error) {
        console.error("Error:", error);
        return res.status(500).json({
...
async function addDocumentEntry52314(document) {
    ...
    try {
        ...
        return { document_status: result.affectedRows > 0, document_id: result.insertId, reminder_status: result2.affectedRows > 0, reminder_id: result2.insertId };
    } catch (error) {
        console.error("Database Error:", error);
