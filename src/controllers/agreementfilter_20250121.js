            ...
            if (user_info && user_info.Status === 2) {
                ...
                if (userflag == 1){
                    if (transporter_id){
                        ...
                        return res.status(400).json("transporter id not found")
                    }
                }
                else if (userflag == 2){
                    ...
                    return res.status(400).json("useflag wrong input value")
                ...
                if (transporter_name){
                    ...
                    return res.status(400).json("transporter name not found")
                }
